/**
 * src/features/exams/components/ExamTableSkeleton.jsx
 */

export default function ExamTableSkeleton({ rows = 5 }) {
  return (
    <div className="overflow-x-auto rounded-xl border border-gray-200 bg-white shadow-sm ring-1 ring-gray-900/5">
      <table className="min-w-full divide-y divide-gray-200">
        <thead className="bg-gray-50/80">
          <tr>
            {['ID', 'Name', 'Class / Subject', 'Date', 'Status', ''].map((h) => (
        ...
        <tbody className="divide-y divide-gray-200">
          {Array.from({ length: rows }).map((_, i) => (
            <tr key={i}>
              <td className="py-3 pl-4"><div className="h-4 w-12 rounded bg-gray-200 animate-pulse font-mono" /></td>
              ...
              <td className="py-3"><div className="h-4 w-24 rounded bg-gray-200 animate-pulse" /></td>
              <td className="py-3"><div className="h-6 w-20 rounded-full bg-gray-200 animate-pulse" /></td>
